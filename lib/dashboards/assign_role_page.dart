...
class _AssignRolePageState extends State<AssignRolePage> {
  ...
  // ================= REMOVE ROLE =================
  Future<void> _removeRole(String admissionNo, String role) async {
    ...
    ScaffoldMessenger.of(
      context,
    ).showSnackBar(SnackBar(content: Text("$role removed successfully")));
  }
        ...
        return ExpansionTile(
          ...
          children: snapshot.data!.docs.map((doc) {
            ...
            return ListTile(
              ...
              subtitle: Text("Admission No: ${data['admissionNo']}"),
              trailing: IconButton(
                icon: const Icon(Icons.delete, color: Colors.red),
                onPressed: () => _removeRole(data['admissionNo'], title),
              ),
            );
          }).toList(),
        );
